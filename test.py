...
model_fp32.export(format="engine", dynamic=True, batch=8, workspace=4, data=yaml_path)
...
model_fp32.export(format="engine", dynamic=True, batch=8, workspace=4, half=True, data=yaml_path)
...
model_fp32.export(format="engine", dynamic=True, batch=8, workspace=4, int8=True, data=yaml_path)
